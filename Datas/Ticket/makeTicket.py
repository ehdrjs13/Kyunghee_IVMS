...
from Datas.Ticket.makeQR import *
...
class MakeTicket():
    ...
    def makeImage(self, num) -> None:
        ...
        self.qr = Image.open(f'Datas/Ticket/qrcodes/{code[1:5]}.jpg')
        self.qr = self.qr.resize((230, 230)) 
        
        self.bg.paste(self.qr, (450, 670), self.qr)

        self.draw.text(self.CodePos, code, fill = (0,0,0),font= ImageFont.truetype('Datas/Ticket/comps/AppleSDGothicNeoB.ttf', size = 15))
        
        self.bg.save(f'Datas/Ticket/savedImg/{num}.png')
