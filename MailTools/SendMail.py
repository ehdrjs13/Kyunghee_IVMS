...
class SendMail():
  ...
  def sendTicket(self, admin_address, admin_pw, address, num):
     ...
     # 이메일 본문 추가
     body = MIMEText('안녕하십니까? 서울고등학교 학생회입니다.\n귀하를 78년의 역사를 지닌 서울고등학교의 축제, 경희제에 초대합니다! \n\n서울고등학교는 제 78회 경희제에서 안전사고 방지와 입장객 수요 관리를 위해 입장 사전 예약제를 도입하였습니다. \n\n이 메일을 받은 외부인께서는 첨부된 티켓 이미지를 사용하여 경희제에 입장하실 수 있습니다.\n입장 방법과 관련해서는 첨부된 입장 매뉴얼을 참고해주시기 바랍니다. \n\n*본 티켓은 입장 신청 설문을 작성하고 학생증을 제출한 학생 본인만 사용 가능합니다. \n*입장 관련 문의 사항은 서울고등학교 학생회 봉사부장(010-3165-3973)이나 서울고등학교 학생회 인스타그램을 통하여 문의 주시기 바랍니다.', 'plain', 'utf-8')
     message.attach(body)



     #사진 첨부
     with open(f'Datas/Ticket/savedImg/{num}.png', 'rb') as image:
