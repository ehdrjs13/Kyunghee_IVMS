...
class SendMail():
  ...
  def sendTicket(self, admin_address, admin_pw, address, num):
     ...
     message['To'] = address
     subject = "제 77회 서울고등학교 경희제 입장 티켓 배부(재발송)"
     message['Subject'] = subject

     # 이메일 본문 추가
     body = MIMEText('안녕하십니까? 서울고등학교 학생회입니다.\n귀하를 77년의 역사를 지닌 서울고등학교의 축제, 경희제에 초대합니다! \n\n서울고등학교는 제 77회 경희제에서 안전사고 방지와 입장객 수요 관리를 위해 입장 사전 예약제를 도입하였습니다. \n\n이 메일을 받은 외부인께서는 첨부된 티켓 이미지를 사용하여 경희제에 입장하실 수 있습니다.\n입장 방법과 관련해서는 첨부된 입장 매뉴얼을 참고해주시기 바랍니다. \n\n*본 티켓은 입장 신청 설문을 작성하고 학생증을 제출한 학생 본인만 사용 가능합니다. \n*입장 관련 문의 사항은 서울고등학교 학예부장(010-9992-0460)나 서울고등학교 학생회 인스타그램을 통하여 문의 주시기 바랍니다. \n\n\n중요!!!!!!!!!!!!!!!!!\n현재 시스템오류로 인해서 신청 인원의 일부에게 여러개의 메일이 발송되거나, 타인의 티켓이 잘못 발송되었습니다. \n시스템 오류를 수정하였으며, 입장객분들께서는 현재 재발송된 !!!!!연두색 테두리를 가진 티켓!!!!! 만이 유효한 티켓이므로 연두색 티켓을 입장시에 제시하여 주시기 바랍니다. 착오를 유발한 점 깊이 사과드립니다.  ', 'plain', 'utf-8')
     message.attach(body)
     ...
     with open('Reference/howToUseIVMS.jpg', 'rb') as image:
         readme = image.read()  # 이미지 파일 읽어오기

     image_type = 'jpg' 
     readme_attatch = MIMEText(readme, 'base64', 'utf-8')
     readme_attatch.add_header('Content-Disposition', 'attachment', filename='README.jpg')

     message.attach(readme_attatch)
